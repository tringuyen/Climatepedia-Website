...
//If the error occures the file will not be uploaded.
 ...
 if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) 
		...
		//print error message
 			...
 			$errors=1;
 			header("Location:http://www.climatepedia.org/admin.php?console=podium&action=failure&type=image&error_message=" . $error_message);
 		}
 		else
 		{
...
$i++;
	...
	header("Location:http://www.climatepedia.org/admin.php?console=podium&action=success&type=new&query=professor_image&title=" . $post_name);

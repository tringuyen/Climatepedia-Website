...
<div id="wrapper"> <!-- Wraps whole page content -->
	...
	<div id="focus_bar">
		...
		<div id="focus_sort">
			<a href="#" id="media_sort_button" >Sort Media by<img src="/css/images/arrow_down.png" alt="" ></a>
			<div id="media_sort_wrapper">
				<div id="media_sort_list" class="shadow">
					<ul>
						<li><a href="/media" >All</a></li>					
						<li><a href="/media/sort/photos" >Photos</a></li>		
						<li><a href="/media/sort/videos" >Videos</a></li>								
					</ul>
				</div>
			</div>				
		</div>

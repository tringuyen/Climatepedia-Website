	...
	<div id="right">
		...
		echo "<div id=knowledge_images class=right_section>"; ?>
			<h3 class="right_header"><?php echo("$main_article_name"); ?> images</h3>
				...
				echo ("<a class=knowledge_image href=http://www.climatepedia.org/images_pedia/" . $image_path . " title='" . $image_source . "'><img src=http://www.climatepedia.org/images_pedia/" . $image_path . " width=160px title='" . $image_description . "'><div class=image_width>" . $image_width . "</div><div class=image_height>" . $image_height . "</div></a>");

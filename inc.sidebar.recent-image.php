<?php include ("inc.main.connect.php");
		...
		$image_description .= " <a href=http://www.climatepedia.org/media/album/" . $row['album_url'] . ">View more in the " . $row['album_name'] . " album</a> in the media gallery of Climatepedia.";
		...
		echo ("<a class='sidebar_image' href='http://www.climatepedia.org/images_media/images_full/" . $image_path . "' title='" . $image_source . "'><img src='http://www.climatepedia.org/images_media/images_full/" . $image_path . "' width=160px title='" . $image_description . "'><div class=image_width>" . $image_width . "</div><div class=image_height>" . $image_height . "</div></a>");

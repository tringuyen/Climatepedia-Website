...
<h3><a href=/beta/newclimate/media/album/" . $row['album_url'] . ">" . $row['album_name'] . "</a> (" . $row['album_count'] . ")</h3>
...
<div class=album_entry>
<h3><a href=/beta/newclimate/media/album/knowledgepedia-images>Knowledgepedia Images</a> (" . $count . ")</h3>
...
<div class=album_entry>
<h3><a href=/beta/newclimate/media/album/podium-images>Professor's Podium Images</a> (" . $count . ")</h3>
...
<div class=album_entry>
<h3><a href=/beta/newclimate/media/album/blog-images>Stack o' Blogs Images</a> (" . $count . ")</h3>
...
echo ("<p id=section_note><a style=font-weight:100 href=/beta/newclimate/media>&larr; Go back to the main media gallery page</a></p>");
...
<a id=image" . $i . " rel=" . $i . " class=media_thumb href=/beta/newclimate/images_media/images_full/" . $image_path . " title='" . $image_source . "'>
	<img width=135px src=/beta/newclimate/images_media/images_thumbs/" . $image_counter . "_thumb.jpg title='" . $image_description . "'>
...
<a id=image" . $i . " rel=" . $i . " class=media_thumb href=/beta/newclimate/images_pedia/" . $image_path . " title='" . $image_source . "'>
	<img width=135px src=/beta/newclimate/images_pedia/" . $image_path . " title='" . $image_description . "'>
	<div class=image_width>" . $image_width . "</div>
	<div class=image_height>" . $image_height . "</div>
</a>
</div>
...
echo ("<p id=section_note><a style=font-weight:100 href=/beta/newclimate/media/album/" . $album_url . ">&larr; Go back to the " . $album_name . " album</a></p>");
...
<h3><a href=/beta/newclimate/media/album/" . $album_url . "/" . $row['video_url'] . ">" . $row['video_name'] . "</a> (" . $video_date . ")</h3>

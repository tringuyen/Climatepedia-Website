...
echo ("<p>You can view the updated article here: <a target=blank href=http://www.climatepedia.org/beta/newclimate/" . $_GET["url"] . ".php>" . $edited_resource . "</a>.</p>");
...
<img class=editable_image src=http://www.climatepedia.org/beta/newclimate/images_pedia/" . $row['image_path'] . ">
<a class=editable_image_link target=blank href=http://www.climatepedia.org/beta/newclimate/images_pedia/" . $row['image_path'] . ">Link to full-size version</a><p style=clear:none;padding-left:5px;line-height:20px;margin-top:0><small>(opens in a new tab)</small></p>
...
<p>You can view the new article here: <a target=blank href=http://www.climatepedia.org/beta/newclimate/" . $_GET["url"] . ".php>" . urldecode($_GET["resource"]) . "</a>.</p>");
...
<p>You can view the new image in the article here: <a target=blank href=http://www.climatepedia.org/beta/newclimate/" . $_GET['url'] . ".php>Updated article</a>. If you don't see your new image double-check that 'Enable images' is checked in the 'Edit Articles' menu.</p>
...
<p>You can view the new image in the article here: <a href=http://www.climatepedia.org/beta/newclimate/" . $_GET['url'] . ".php>View the article you updated</a>. If you don't see your new image double-check that 'Enable images' is checked in the 'Edit Articles' menu.</p>
...
<img class=editable_image id=image_edit" . $image_number . " src=http://www.climatepedia.org/beta/newclimate/images_pedia/" . $row['image_path'] . ">

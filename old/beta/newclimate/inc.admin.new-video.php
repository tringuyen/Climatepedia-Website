...
header("Location:http://www.climatepedia.org/beta/newclimate/admin?console=media&action=success&type=new&query=video&title=" . $video_name . "&albumurl=" . $album_url . "&videourl=" . $video_url);

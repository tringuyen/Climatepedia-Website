...
if(isset($_GET['directory'])) {
	...
	echo ("<p id=section_note><a style=font-weight:100 href=/beta/newclimate/podium/network>&larr; Go back to the professor list</a></p>");
	...
	$professor_id = $_GET['professor'];
		...
		while($row=$result->fetch_array()) {
			...
			while($row=$result->fetch_array()) {
				...
				$image_path = "/beta/newclimate/images_podium/professors/" . $row['image_path'];
			...
			while($row=$result->fetch_array()) {
				...
				$image_path = "/beta/newclimate/images_podium/universities/" . $row['image_path'];
				$image_description = $row['image_description'];
				$image_source = $row['image_source'];
				...
				$image_path = "/beta/newclimate/css/images/climatepedia-logo.png";
			...
			echo ("<h2 class=historyheader><a href=/beta/newclimate/podium/" . $row['post_url'] . ">" . $row['post_name'] . "</a><span class=historydate> - " . $post_date . "</span></h2>");
	...
	echo ("<p id=section_note><a style=font-weight:100 href=/beta/newclimate/podium>&larr; Go back to the professor's podium</a></p>");
	if(isset($_GET['sort'])) {
		// we're sorting	
	...
	$professor_id = $_GET['professor'];
		...
		while($row=$result->fetch_array()) {
			...
			$professor_bio = preg_replace("/\s+?(\S+)?$/", " ... <a style=text-decoration:underline;font-weight:100 href=/beta/newclimate/podium/network/" . $professor_id . "/" . $professor_url . " title='Click to view the Climatepedia profile of " . $post_professor . ".'>More ></a>", substr($professor_bio, 0, 201));
			...
			while($row2=$result2->fetch_array()) {
				...
				$image_path = "/beta/newclimate/images_podium/professors/" . $row2['image_path'];
			...
			while($row2=$result2->fetch_array()) {
				...
				$image_path = "/beta/newclimate/images_podium/universities/" . $row2['image_path'];
				$image_description = $row2['image_description'];
				$image_source = $row2['image_source'];
			...
			<h2><a href=/beta/newclimate/podium/network/" . $professor_id . "/" . $professor_url . " target=_blank title='Click to view the Climatepedia profile of " . $post_professor . ".'>" . $professor_name . "</a></h2>
...
echo ("<p id=section_note><a style=font-weight:100 href=/beta/newclimate/podium>&larr; Go back to the post list</a></p>");
...
while($row=$result->fetch_array()) {
 ...
 if($row['professor_picture'] == 1) {
	...
	while($row2=$result2->fetch_array()) {
		...
		echo ("<a href=/beta/newclimate/podium/network/" . $professor_id . "/" . $professor_url . " target=_blank title='Click to view the Climatepedia profile of " . $post_professor . ".'><img class=professor_profile width=80px align=left src=http://www.climatepedia.org/beta/newclimate/images_podium/professors/" . $row2['image_path'] . " ></a>");
...
elseif($row['professor_picture'] == 0) {
	...
	while($row2=$result2->fetch_array()) {
		...
		echo ("<img class=professor_profile width=80px align=left src=http://www.climatepedia.org/beta/newclimate/images_podium/universities/" . $row2['image_path'] . " >");
	...
	elseif($row['university_images'] == 0) {
		...
		echo ("<img class=professor_profile width=80px align=left src=http://www.climatepedia.org/beta/newclimate/css/images/climatepedia-logo.png>");
	...
	echo ("
	<h2 class=post_header><a href=/beta/newclimate/podium/" . $post_url . ">" . $post_name . "</a></h2>
	<p class=entry_meta><span class=entry_professor><a href=/beta/newclimate/podium/network/" . $professor_id . "/" . $professor_url . " target=_blank title='Click to view the Climatepedia profile of " . $post_professor . ".'>" . $post_professor . "</a></span><br><span class=entry_university>" . $post_university . "</span> <span class=entry_date>" . $post_date . "</span></p>"
	. $post_content . "
...
elseif($row['professor_picture'] == 0) {
	...
	echo ("
	<h2 class=listheader><a href=/beta/newclimate/podium/" . $post_url . ">" . $post_name . "</a></h2>
	<p class=entry_meta><span class=entry_professor><a href=/beta/newclimate/podium/network/" . $professor_id . "/" . $professor_url . " target=_blank title='Click to view the Climatepedia profile of " . $post_professor . ".'>" . $post_professor . "</a></span><br><span class=entry_university>" . $post_university . "</span> <span class=entry_date>" . $post_date . "</span></p>
	<p class=entry_summary>" . $post_summary . "</p>
	<p class=continue_link><a href=/beta/newclimate/podium/" . $post_url . ">Read the full post &rarr;</a><p>
	</div>
	");

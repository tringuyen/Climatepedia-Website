...
<p>The post you edited was: <a target=_blank href=http://www.climatepedia.org/podium/" . $post_url . ">" . $edit_post_stripped . "</a>.</p>
...
<img class=editable_image src=http://www.climatepedia.org/images_podium/" . $folder . "/" . $row['image_path'] . ">
<a class=editable_image_link target=blank href=http://www.climatepedia.org/images_podium/" . $folder . "/" . $row['image_path'] . ">Link to full-size version</a><p style=clear:none;padding-left:5px;line-height:20px;margin-top:0><small>(opens in a new tab)</small></p>
...
<p>The post you created was: <a target=_blank href=http://www.climatepedia.org/podium/" . $post_url . ">" . $new_post_stripped . "</a>.</p>
...
<h1>Congrats, your new image was uploaded.</h1>
<p>You can view the new image in the post here: <a target=blank href=http://www.climatepedia.org/podium/" . $_GET['url'] . ">" . $new_post_stripped . "</a>. If you don't see your new image double-check that 'Enable images' is checked for your post in the 'Edit Post' menu.</p>
...
<p>You can view the new images in the post here: <a target=blank href=http://www.climatepedia.org/podium/" . $_GET['url'] . ">" . $new_post_stripped . "</a>. If you don't see your new image double-check that 'Enable images' is checked for your post in the 'Edit Post' menu.</p>
...
elseif($_GET["action"] == "new_images") {
	...
	<a class=choose_podium_link href=/admin?console=podium&action=new_post_images>Images to go with a professor's post</a><br>
	<a class=choose_podium_link href=/admin?console=podium&action=new_professor_images>A picture of a professor for his directory profile</a><br>
	<a class=choose_podium_link href=/admin?console=podium&action=new_university_images>University images/logos</a>
...
<h1>Choose which type of Podium images you want to edit</h1>
	<a class=choose_podium_link href=/admin?console=podium&action=choose_post_images>Images to go with a professor's post</a><br>
	<a class=choose_podium_link href=/admin?console=podium&action=choose_professor_images>A picture of a professor for his directory profile</a><br>
	<a class=choose_podium_link href=/admin?console=podium&action=choose_university_images>University images/logos</a>
...
<img class=editable_image id=image_edit" . $image_number . " src=http://www.climatepedia.org/images_podium/posts/" . $row['image_path'] . ">
<input type=hidden name=edit_submit_image_path value=" . $row['image_path'] . ">

<a class=editable_image_link target=blank href=http://www.climatepedia.org/images_podium/posts/" . $row['image_path'] . ">Link to full-size version</a><p style=clear:none;padding-left:5px;line-height:20px;margin-top:0><small>(opens in a new tab)</small></p>
...
<img class=editable_image id=image_edit" . $image_number . " src=http://www.climatepedia.org/images_podium/professors/" . $row['image_path'] . ">
<input type=hidden name=edit_submit_image_path value=" . $row['image_path'] . ">

<a class=editable_image_link target=blank href=http://www.climatepedia.org/images_podium/professors/" . $row['image_path'] . ">Link to full-size version</a><p style=clear:none;padding-left:5px;line-height:20px;margin-top:0><small>(opens in a new tab)</small></p>
<p style=clear:left;padding-right:5px><strong>Description:</strong> </p><p id=image" . $image_number . "_description class=editable_image_description>" . $image_description . "</p>
<p style=clear:left;padding-right:5px><strong>Source:</strong> </p><p id=image" . $image_number . "_source class=editable_image_source>" . $image_source . "</p>
<a id=edit_image". $image_number . "_trigger style=margin-top:5px title=" . $row['image_id'] . " class=editable_image_trigger href=image" . $image_number . ">&uarr; Edit this image</a>
<a id=delete_image". $image_number . "_trigger style=margin-bottom:30px;margin-top:5px class=delete_image_trigger href=" . $row["image_id"] . "><span style=color:red>X </span>Delete this image</a>
...
<img class=editable_image id=image_edit" . $image_number . " src=http://www.climatepedia.org/images_podium/universities/" . $row['image_path'] . ">
<input type=hidden name=edit_submit_image_path value=" . $row['image_path'] . ">

<a class=editable_image_link target=blank href=http://www.climatepedia.org/images_podium/universities/" . $row['image_path'] . ">Link to full-size version</a><p style=clear:none;padding-left:5px;line-height:20px;margin-top:0><small>(opens in a new tab)</small></p>
<p style=clear:left;padding-right:5px><strong>Description:</strong> </p><p id=image" . $image_number . "_description class=editable_image_description>" . $image_description . "</p>
<p style=clear:left;padding-right:5px><strong>Source:</strong> </p><p id=image" . $image_number . "_source class=editable_image_source>" . $image_source . "</p>
<a id=edit_image". $image_number . "_trigger style=margin-top:5px title=" . $row['image_id'] . " class=editable_image_trigger href=image" . $image_number . ">&uarr; Edit this image</a>
<a id=delete_image". $image_number . "_trigger style=margin-bottom:30px;margin-top:5px class=delete_image_trigger href=" . $row["image_id"] . "><span style=color:red>X </span>Delete this image</a>

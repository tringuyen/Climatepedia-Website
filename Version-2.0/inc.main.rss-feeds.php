...
while($page_builder_i <= $number_of_pages) {
	...
	<a href=/news/" . $_GET['keyword'] . "/page/" . $page_builder_i . "&sort=" . $_GET['sort'] . " class=page_link>" . $page_builder_i . "</a>
	...
	<a href=/news/" . $_GET['keyword'] . "/page/" . $page_builder_i . " class=page_link>" . $page_builder_i . "</a>

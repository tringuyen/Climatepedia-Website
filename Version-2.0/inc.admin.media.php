...
<img class=editable_image src=http://www.climatepedia.org/images_media/images_full/" . $row['image_path'] . ">
<img class=editable_image src=http://www.climatepedia.org/images_media/images_thumbs/" . $row['image_id'] . ">
<a class=editable_image_link target=blank href=http://www.climatepedia.org/images_media/images_full/" . $row['image_path'] . ">Link to full-size version</a><p style=clear:none;padding-left:5px;line-height:20px;margin-top:0><small>(opens in a new tab)</small></p>
...
<p>You can find the video you edited here: <a href=/media/album/" . $_GET['albumurl'] . "/" . $_GET['videourl'] . " target=_blank>" . $new_video_stripped . "</a>.</p>
...
<p>You can view the new photo in the album here: <a target=blank href=http://www.climatepedia.org/media/album/" . $_GET['url'] . ">" . $new_album_stripped . "</a>.</p>
...
<p>You can view the new photos in the album here: <a href=http://www.climatepedia.org/media/album/" . $_GET['url'] . ">" . $new_album_stripped . "</a>.</p>
...
<p>You can find the video you created here: <a href=/media/album/" . $_GET['albumurl'] . "/" . $_GET['videourl'] . " target=_blank>" . $new_video_stripped . "</a>.</p>
...
<img class=editable_image id=image_edit" . $image_number . " src=http://www.climatepedia.org/images_media/images_full/" . $row['image_path'] . ">
<img class=editable_image id=image_thumb" . $image_number . " src=http://www.climatepedia.org/images_media/images_thumbs/" . $row['image_counter'] . "_thumb.jpg>

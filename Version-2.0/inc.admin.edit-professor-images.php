...
$image_path = "images_podium/professors/" . $_POST['edit_submit_image_path'];
...
header("Location:http://www.climatepedia.org/admin.php?console=podium&action=success&type=edit&query=images&function=delete");
...
header("Location:http://www.climatepedia.org/admin.php?console=podium&action=success&type=edit&query=images&function=alter&id=" . $image_id);

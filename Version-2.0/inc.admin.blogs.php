...
<p>The post you edited was: <a target=_blank href=http://www.climatepedia.org/blogs/post/" . $post_id . ">" . $edit_post_stripped . "</a>.</p>
...
<img class=editable_image src=http://www.climatepedia.org/images_blog/" . $row['image_path'] . ">
<a class=editable_image_link target=blank href=http://www.climatepedia.org/images_blog/" . $row['image_path'] . ">Link to full-size version</a><p style=clear:none;padding-left:5px;line-height:20px;margin-top:0><small>(opens in a new tab)</small></p>
...
<p>The post you created was: <a target=_blank href=http://www.climatepedia.org/blogs/post/" . $post_id . ">" . $new_post_stripped . "</a>.</p>
...
<p>The blog you created was: " . $new_blog_stripped . ". You should now see this blog in our Stack o' Blogs sidebar: <a target=_blank href=http://www.climatepedia.org/blogs>Stack o' Blogs main page</a>.</p>
...
<p>You can view the new image in the article here: <a target=blank href=http://www.climatepedia.org/blogs/post/" . $_GET['id'] . ">" . $new_blog_stripped . "</a>. If you don't see your new image double-check that 'Enable images' is checked for your post in the 'Edit Post' menu.</p>
...
<p>You can view the new image in the article here: <a href=http://www.climatepedia.org/blogs/post/" . $_GET['id'] . ">" . $new_blog_stripped . "</a>. If you don't see your new image double-check that 'Enable images' is checked for your post in the 'Edit Post' menu.</p>
...
<img class=editable_image id=image_edit" . $image_number . " src=http://www.climatepedia.org/images_blog/" . $row['image_path'] . ">

...
<div id="wrapper"> <!-- Wraps whole page content -->
	...
	<div id="focus_bar">
		...
		<div id="focus_sort">
			...
			<a href="#" id="media_sort_button" >Sort Professors<img src="/css/images/arrow_down.png" alt="" ></a>
			<div id="media_sort_wrapper">
				<div id="media_sort_list" class="shadow">
					<ul>					
						<li><a href="/podium/network/sort/first-name-alphabetical" >First Name<br>A - Z</a></li>
						<li><a href="/podium/network/sort/last-name-alphabetical" >Last Name<br>A - Z</a></li>
						<li><a href="/podium/network/sort/first-name-inverse" >First Name<br>Z - A</a></li>
						<li><a href="/podium/network/sort/last-name-inverse" >Last Name<br>Z - A</a></li>
			<?php } else { ?>
			<a href="#" id="media_sort_button" >Sort Posts by<img src="/css/images/arrow_down.png" alt="" ></a>
			<div id="media_sort_wrapper">
				<div id="media_sort_list" class="shadow">
					<ul>
						<li><a href="/podium" >Most Popular</a></li>					
						<li><a href="/podium" >Newest</a></li>		
						<li><a href="/podium/sort/oldest" >Oldest</a></li>
						<li><a href="/podium/sort/alphabetical" >A - Z</a></li>
						<li><a href="/podium/sort/inverse" >Z - A</a></li>
			<?php }?>								
					</ul>
				</div>
			</div>				
	...
	<div id="professor_nav">
		<p>Professor Links</p>	
		<ul>
			<li><a href="/podium" >Podium Posts</a></li>
			<li><a href="/podium/network" >Academic Network</a></li>

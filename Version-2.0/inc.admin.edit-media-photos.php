...
header("Location:http://www.climatepedia.org/admin.php?console=media&action=success&type=edit&query=images&function=delete");
...
header("Location:http://www.climatepedia.org/admin.php?console=media&action=success&type=edit&query=images&function=alter&id=" . $image_id);

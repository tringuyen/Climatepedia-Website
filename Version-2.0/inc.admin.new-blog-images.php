...
//If the error occures the file will not be uploaded.
 ...
 if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) 
		...
		//print error message
 			...
 			$errors=1;
 			header("Location:http://www.climatepedia.org/admin.php?console=blogs&action=failure&type=image&error_message=" . $error_message);
 		}
 		else
 		{
...
$i++;
	...
	header("Location:http://www.climatepedia.org/admin.php?console=blogs&action=success&type=new&query=images&title=" . $post_name . "&id=" . $post_id . "&total=" . $i);

...
//If the error occures the file will not be uploaded.
 ...
 if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) 
		...
		//print error message
 			...
 			$errors=1;
 			header("Location:http://www.climatepedia.org/admin.php?console=media&action=failure&type=image&error_message=" . $error_message);
 		}
 		else
 		{
...
$c++; // used to keep track of unique identifier names for images
	...
	header("Location:http://www.climatepedia.org/admin.php?console=media&action=success&type=new&query=photos&url=" . $album_url . "&title=" . $album_name . "&total=" . $total_images);

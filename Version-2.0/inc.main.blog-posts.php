...
<p class=back_link><a href=/blogs>&larr; Go back to the blog list</a></p>
<h2>" . $row['post_name'] . "</h2>
...
<div class=post_entry>
<h2><a href=http://www.climatepedia.org/blogs/post/" . $post_id . ">" . $post_name . "</a></h2>
<p class=post_meta><span class=post_source>" . $post_source . "</span><span class=post_date>" . $post_date . "</span></p>
<p>" . $post_summary . "</p>
<p class=back_link><a href=http://www.climatepedia.org/blogs/post/" . $post_id . ">Read the full post &rarr;</a></p>
</div>
...
while($page_builder_i <= $number_of_pages) {
	...
	<a href=/blogs/page/" . $page_builder_i . "&sort=" . $_GET['sort'] . " class=page_link>" . $page_builder_i . "</a>
	...
	<a href=/blogs/page/" . $page_builder_i . " class=page_link>" . $page_builder_i . "</a>

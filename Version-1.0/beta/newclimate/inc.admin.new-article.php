...
header("Location:http://www.climatepedia.org/beta/newclimate/admin.php?console=knowledge&action=success&type=new&query=article&resource=" . $article_name . "&url=" . $article_url);

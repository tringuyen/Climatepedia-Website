...
header("Location:http://www.climatepedia.org/beta/newclimate/admin?console=podium&action=success&type=new&query=professor&title=" . $professor_firstname . "%20" . $professor_lastname);

...
<div id="wrapper"> <!-- Wraps whole page content -->
	...
	<div id="focus_bar">
		...
		<div id="focus_sort">
			<a href="#" id="org_sort_button" >More Info <img src="/beta/newclimate/css/images/arrow_down.png" alt="" ></a>
			<div id="org_sort_wrapper">
				<div id="org_sort_list" class="shadow">
					<ul>
						<li><a href="/beta/newclimate/organization/about-climatepedia" >About Us</a></li>					
						<li><a href="/beta/newclimate/organization/how-to-contribute" >Contributing</a></li>		
						<li><a href="/beta/newclimate/org/organization/faq" >FAQ</a></li>								
					</ul>
				</div>
			</div>				
		</div>

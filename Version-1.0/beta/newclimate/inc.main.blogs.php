...
<div id="wrapper"> <!-- Wraps whole page content -->
	...
	<div id="focus_bar">
		...
		<div id="focus_sort">
			<a href="#" id="blogs_sort_button" >Sort Posts by<img src="/beta/newclimate/css/images/arrow_down.png" alt="" ></a>
			<div id="blogs_sort_wrapper">
				<div id="blogs_sort_list" class="shadow">
					<ul>
						<li><a href="/beta/newclimate/blogs" >View All</a></li>					
						<li><a href="/beta/newclimate/blogs/page/<?php echo $blog_page; ?>&sort=newest" >Newest</a></li>		
						<li><a href="/beta/newclimate/blogs/page/<?php echo $blog_page; ?>&sort=oldest" >Oldest</a></li>
						<li><a href="/beta/newclimate/blogs/page/<?php echo $blog_page; ?>&sort=alphabetical" >A - Z</a></li>
						<li><a href="/beta/newclimate/blogs/page/<?php echo $blog_page; ?>&sort=inverse" >Z - A</a></li>								
					</ul>
				</div>
			</div>				
		</div>
	...
	<div id="right">
		...
		echo "<div id=blog_images class=right_section>"; ?>
			<h3 class="right_header">Images with this post</h3>
				...
				list($image_width, $image_height, $type, $attr) = getimagesize("http://www.climatepedia.org/beta/newclimate/images_blog/" . $image_path);


				echo ("<a class='sidebar_image' href='http://www.climatepedia.org/beta/newclimate/images_blog/" . $image_path . "' title='" . $image_source . "' rel=gallery ><img src='http://www.climatepedia.org/beta/newclimate/images_blog/" . $image_path . "' width=160px title='" . $image_description . "'><div class=image_width>" . $image_width . "</div><div class=image_height>" . $image_height . "</div></a>");
